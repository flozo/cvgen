...
public class IconDAOImpl implements IconDAO {
    ...
    public IconDAOImpl(Datasource2 datasource2, Connection connection) {
    ...
    public void add(Icon icon) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(INSERT)) {
            ...
            System.out.println();
            datasource2.rollback(e, "Insert-icon");
        } finally {
    ...
    public void update(Icon icon) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(UPDATE_ROW)) {
            ...
            System.out.println();
            datasource2.rollback(e, "Update-icon");
        } finally {
            datasource2.setAutoCommitBehavior(true);
        }
    }
    ...
    public void delete(Icon icon) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(DELETE)) {
            ...
            System.out.println();
            datasource2.rollback(e, "Delete-icon");
        } finally {
            datasource2.setAutoCommitBehavior(true);
        }
    }
