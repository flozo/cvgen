...
public class PackageOptionDAOImpl implements PackageOptionDAO {
    ...
    public PackageOptionDAOImpl(Datasource2 datasource2, Connection connection) {
    ...
    public void add(PackageOption packageOption) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(INSERT)) {
            ...
            System.out.println();
            datasource2.rollback(e, "Insert-packageOption");
        } finally {
    ...
    public void update(PackageOption packageOption) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(UPDATE_ROW)) {
            ...
            System.out.println();
            datasource2.rollback(e, "Update-packageOption");
        } finally {
            datasource2.setAutoCommitBehavior(true);
        }
    }
    ...
    public void delete(PackageOption packageOption) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(DELETE)) {
            ...
            System.out.println();
            datasource2.rollback(e, "Delete-packageOption");
        } finally {
            datasource2.setAutoCommitBehavior(true);
        }
    }
