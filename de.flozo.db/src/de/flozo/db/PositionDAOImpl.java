...
public class PositionDAOImpl implements PositionDAO {
    ...
    // CREATE VIEW position_view AS SELECT p._id AS position_id, p.name AS position_name,
    ...
    public static final String INSERT = INSERT_INTO + TABLE_NAME +
            OPENING_PARENTHESIS + COLUMN_NAME + COMMA + COLUMN_X_LENGTH_ID + COMMA + COLUMN_Y_LENGTH_ID + CLOSING_PARENTHESIS +
    ...
    public static final String UPDATE_ROW = UPDATE + TABLE_NAME + SET +
            COLUMN_NAME + EQUALS + QUESTION_MARK + COMMA + COLUMN_X_LENGTH_ID + EQUALS + QUESTION_MARK + COMMA +
            COLUMN_Y_LENGTH_ID + EQUALS + QUESTION_MARK + WHERE + COLUMN_ID + EQUALS + QUESTION_MARK;
