...
public class TextItemDAOImpl implements TextItemDAO {
    ...
    public TextItemDAOImpl(Datasource datasource, Connection connection) {
    ...
    public void add(TextItem textItem) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(INSERT)) {
            ...
            System.out.println();
            datasource.rollback(e, "Insert-textItem");
        } finally {
    ...
    public void update(TextItem textItem) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(UPDATE_ROW)) {
            ...
            System.out.println();
            datasource.rollback(e, "Update-textItem");
        } finally {
            datasource.setAutoCommitBehavior(true);
        }
    }
    ...
    public void delete(TextItem textItem) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(DELETE)) {
            ...
            System.out.println();
            datasource.rollback(e, "Delete-textItem");
        } finally {
            datasource.setAutoCommitBehavior(true);
        }
    }
