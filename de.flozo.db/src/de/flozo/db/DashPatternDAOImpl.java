...
public class DashPatternDAOImpl implements DashPatternDAO {
    ...
    public DashPatternDAOImpl(Connection connection) {
    ...
    private DashPattern extractFromResultSet(ResultSet resultSet) throws SQLException {
        return new DashPattern(resultSet.getInt(1), resultSet.getString(2));
    }

    @Override
    public String toString() {
        return "DashPatternDAOImpl{" +
